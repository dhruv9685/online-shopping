          ...
          <div class="jumbotron">
            <div class="container">
                <div class="row">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:MyDBConnection %>" SelectCommand="SELECT [ProductID], [ProductName], [ProductPrice], [ProductImage] FROM [ProductDatabase] where CategoryID='4'"></asp:SqlDataSource>
                </div>
            </div>
        </div>
    </div>
